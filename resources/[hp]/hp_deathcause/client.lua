vRPdt = {}
Tunnel.bindInterface("hp_deathcause",vRPdt)
Proxy.addInterface("hp_deathcause",vRPdt)
DTserver = Tunnel.getInterface("hp_deathcause","hp_deathcause")
vRPserver = Tunnel.getInterface("vRP","hp_deathcause")
	  ...
	  Citizen.Wait(1000)
		while true do
		  ...
		  if not IsPedInAnyVehicle(GetPlayerPed(-1)) then
				...
				local player, distance = GetClosestPed(pos.x,pos.y,pos.z, 20.0, 1, 0, 0, 0, -1)	
