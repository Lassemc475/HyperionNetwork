...
Citizen.CreateThread(function()
    ...
    Citizen.Wait(0)
        ...
        if GetDistanceBetweenCoords(coords, 117.19, -1294.86, 28.42, true) < 100 then
            ...
            drawTxt('[~g~E~s~] for stripshow', 0, 1, 0.5, 0.8, 0.6, 255, 255, 255, 255)
            if IsControlPressed(0,  Keys['E']) then
			TriggerEvent('hp_lapdance:lapdance')
			Citizen.Wait(3000)
            end
        end
    end
...
RegisterNetEvent('hp_lapdance:lapdance')
AddEventHandler('hp_lapdance:lapdance', function()
