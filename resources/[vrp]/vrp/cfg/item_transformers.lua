...
cfg.hidden_transformers = {
  ...
  -- FISK
	...
	["Hampblad farm"] = {
		...
		positions = {
			{594.25524902344,-2094.6735839844,5.7520895004272},
			{1407.0931396484,3668.5307617188,34.001323699951},
			{2221.7927246094,5577.1196289063,53.846015930176}
		},
		duration = math.random(120,300) -- 5 days (time before switching position, min 5 mins.)
	},
	["Hash fremstilling"] = {
		...
		def = {
			...
			recipes = {
				["Sælg hash"] = { -- action name
					description="Sælg dine hashklumper.", -- action description
					work=1,
					in_money=0, -- money taken per unit
					out_money=0, -- money earned per unit
					reagents={ -- items taken per unit
	...
	["Kokaplante farm"] = {
		...
		positions = {
			{846.74212646484,-2526.5737304688,40.772239685059},
			{1919.9481201172,4808.8583984375,44.653816223145},
			{656.89868164063,-785.10632324219,24.549482345581}
		},
		duration = math.random(120,300) -- 5 days (time before switching position, min 5 mins.)
	},
	["Kokain fremstilling"] = {
	...
	["Fernandez Cokeandez"] = { -- Coke dealer
		...
		positions = {
			{568.05218505859,-3117.6628417969,18.768508911133},
	...
	["Sårbar hæveautomat"] = {
		...
		duration = 10 -- 10 minutes (time before switching position, min 5 mins.)
	}
}
...
cfg.informer = {
  ...
  ["Hampblad farm"] = 7500,
  ["Syre produktion"] = 7500,
  ["Kokaplante farm"] = 7500,
  ["Henning Hamphry"] = 7500,
  ["Lars LS Dary"] = 7500,
  ["Fernandez Cokeandez"] = 7500,
  },
  positions = {
