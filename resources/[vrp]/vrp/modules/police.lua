          ...
          vRP.prompt(player,"Nærmeste spiller(e): " .. usrList .. "","",function(player,user_id) 
            ...
            if user_id ~= nil and user_id ~= "" then 
              ...
              if target ~= nil then
                ...
                Wait(4000)
              TriggerClientEvent("pNotify:SendNotification", player,{text = user_id.. " har en promille på "..(promille/100).."‰", type = "success", queue = "global", timeout = 4000, layout = "centerLeft",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
              end
            else
             TriggerClientEvent("pNotify:SendNotification", player,{text = {"Intet ID valgt"}, type = "warning", queue = "global", timeout = 4000, layout = "centerLeft",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
            end
