...
function checkSpeed()
    ...
    if kmhspeed > 55 and kmhspeed <= 65 and field == "1" and driver == pP then
        tax = 4000
        ...
        exports.pNotify:SendNotification({text = "<b style='color:#ED2939'>Fartfælde</b><br /><br />Du kørte " .. kmhspeed .. "km/t hvor du må køre 50 km/t <br /><b style='color:#26ff26'>Bøde</b>: " .. tax .."DKK",type = "error",timeout = 8000,layout = "centerLeft",queue = "left"})
    ...
    elseif kmhspeed > 85 and kmhspeed <= 104 and field == "2" and driver == pP then
        ...
        TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 10, "fartfaelde", 0.8)
        exports.pNotify:SetQueueMax("left", 1)
        exports.pNotify:SendNotification({text = "<b style='color:#ED2939'>Fartfælde</b><br /><br />Du kørte " .. kmhspeed .. "km/t hvor du må køre 80 km/t <br /><b style='color:#26ff26'>Bøde</b>: " .. tax .."DKK",type = "error",timeout = 8000,layout = "centerLeft",queue = "left"})
    ...
    elseif kmhspeed > 135 and kmhspeed <= 159 and field == "3" and driver == pP then
        ...
        TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 10, "fartfaelde", 0.8)
        exports.pNotify:SetQueueMax("left", 1)
        exports.pNotify:SendNotification({text = "<b style='color:#ED2939'>Fartfælde</b><br /><br />Du kørte " .. kmhspeed .. "km/t hvor du må køre 130 km/t <br /><b style='color:#26ff26'>Bøde</b>: " .. tax .."DKK",type = "error",timeout = 8000,layout = "centerLeft",queue = "left"})
    elseif kmhspeed > 135 and kmhspeed <= 159 and field == "3" and driver == pP then
        tax = 6000
        TriggerServerEvent('betalFart',tax)
        Wait(1000)
