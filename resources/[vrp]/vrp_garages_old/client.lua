...
local garages = {
  ...
  {name="Garage", colour=3, id=357, marker=27, x=1992.5806884766, y=3031.3732910156, z=46.058331634521, h=0.0, hidden=false}, --Yellow Jack P-Plads
  ...
  {name="Garage", colour=3, id=357, marker=27, x=-47.580795288086, y=-1111.4187011719, z=25.448817718506, h=0.0, hidden=true}, -- Bilbutik garage
  ...
  {name="Garage", colour=3, id=357, marker=27,  x=-292.32995605469, y=-990.51977539063,  z=22.737056350708, h=0.0, hidden=true}, -- AK Kartellet
...
function deleteCar( entity )
        ...
        Citizen.InvokeNative(0xAD738C3085FE7E11, entity, false, true) -- set not as mission entity
        DeleteEntity(entity)
      ...
      DrawMarker(27, garage.x, garage.y, garage.z, 0, 0, 0, 0, 0, 0, 3.001, 3.0001, 0.5001, 0, 155, 255, 200, 0, 0, 0, 0)
      	...
      	if GetDistanceBetweenCoords(garage.x, garage.y, garage.z, GetEntityCoords(LocalPed())) < 3 then
        	  ...
        	  Menu.renderGUI() 
      		 ...
      		 ply_drawTxt(lang_string.daybournekek,0,1,0.5,0.8,0.6,255,255,255,255)
      	   end
       end
    end
  end
